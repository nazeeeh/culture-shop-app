...
export default {
    data () {
      return {
        contents: [
            {name: 'Vendors online', rate: 0, backgroundColor: '#E7F7F1', color: '#0CAD73'},
            {name: 'Pending orders', rate: 0, backgroundColor: '#FDF0E8', color: '#E76D14'},
            {name: 'Confirmed orders', rate: 0, backgroundColor: '#E7F7F1', color: '#0CAD73'},
            {name: 'Completed orders', rate: 0, backgroundColor: '#E7F7F1', color: '#0CAD73'},

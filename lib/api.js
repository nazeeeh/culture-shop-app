 ...
 */
 export function CsRequests(instance, services, store, auth, snackbar) {
    ...
    CUSTOMERS SECTION
     ...
     /* =======================================================
    GET A CUSTOMERS SECTION
     ========================================================= */

     this.getCustomer = async function(id) {
      try{
        const { data } = await this.instance.get(`${this.services.customer.getaCustomer}/${id}`)
        return data
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
     ...
     this.editCustomer = async function(payload, id) {
      try{
        const postData = await this.instance.post(`${this.services.customer.editCustomer}/${id}`, payload)
        return postData
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
...
/* =======================================================
     ...
     this.addVendor = async function(payload) {
      try{
        const postData  = await this.instance.post(`${this.services.vendor.addVendors}`, payload)
        return postData
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
    ...
    /* =======================================================
     ...
     this.getVendors = async function() {
      try{
        const { data }  = await this.instance.get(`${this.services.vendor.getVendors}`)
        return data
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
     ...
     this.getDriver = async function() {
      try{
        const { data } = await this.instance.get(`${this.services.driver.getDrivers}`)
        return data
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
     ...
     this.addDriver = async function(payload) {
      try{
        const postData = await this.instance.post(`${this.services.driver.addDriver}`, payload)
        return postData
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
     ...
     this.getaDriver = async function(id) {
      try{
        const data = await this.instance.get(`${this.services.driver.getaDriver}/${id}`)
        return data
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
     ...
     this.editDriver = async function(payload, id) {
      try{
        const postData = await this.instance.post(`${this.services.driver.editDriver}/${id}`, payload)
        return postData
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
     ...
     this.addCategory = async function(payload) {
      try{
        const postData = await this.instance.post(`${this.services.category.addCategory}`, payload)
        return postData
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
     ...
     this.getCategory = async function() {
      try{
        const { data } = await this.instance.get(`${this.services.category.getCategory}`)
        return data
      }catch (error){
        this.processError(error)
        return Promise.reject(error)
